...
namespace wingify\Packages\Logger\Core;

use wingify\Constants\Constants;
use wingify\Packages\Logger\Enums\LogLevelEnum;
use Ramsey\Uuid\Uuid;
use wingify\Packages\Logger\Core\LogTransportManager;
use wingify\Packages\Logger\Core\Logger;
...
class LogManager extends Logger implements ILogManager {
    ...
    private $config;
    private $name = Constants::LOGGER_NAME_WINGIFY;
    private $requestId;
    private $level = LogLevelEnum::ERROR;
    private $prefix = Constants::LOG_PREFIX_WINGIFY;
