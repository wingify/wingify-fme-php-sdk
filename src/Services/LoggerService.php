...
class LoggerService {
     ...
     */
    public function log($level, $key, $map = [], $shouldLogToServer = true) {
    ...
    public function error($key, $map = [], $shouldLogToServer = true) {
        $this->log(LogLevelEnum::ERROR, $key, $map, $shouldLogToServer);
    }
    ...
    /**
     * Sends an error log as a debug event to the FME platform.
     *
