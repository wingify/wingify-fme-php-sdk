...
class SettingsService implements ISettingsService {
    ...
    public $hostProfile = Constants::HOST_PROFILE_WINGIFY;
    public $port;
    ...
    public function __construct($options, $logManager, $loggerService) {
        ...
        $profile = isset($options['hostProfile']) ? $options['hostProfile'] : Constants::HOST_PROFILE_WINGIFY;
    ...
    /**
     * @param string $profile Constants::HOST_PROFILE_VWO or HOST_PROFILE_WINGIFY
     */
    private function applyPlatformHosts($profile)
    {
        if ($profile === Constants::HOST_PROFILE_VWO) {
