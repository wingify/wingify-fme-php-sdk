...
class WingifyClient implements IWingifyClient {
    public $settings;
    ...
    private function initialize(array $options, $settings) {
        ...
        $loggerName = LogPrefixUtil::resolveLoggerName($this->options);
        $this->serviceContainer->getLogManager()->info("{$loggerName} initialized");
    }
