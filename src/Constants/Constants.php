...
class Constants {
    ...
    const LEGACY_HOST = 'dev.visualwebsiteoptimizer.com';
    const EDGE_HOST = 'edge.wingify.net';
    const COLLECT_HOST = 'collect.wingify.net';

    const HOST_PROFILE_VWO = 'vwo';
    const HOST_PROFILE_WINGIFY = 'wingify';

    const LOG_PREFIX_WINGIFY = 'Wingify-SDK';
    const LOG_PREFIX_VWO = 'VWO-SDK';
    const LOGGER_NAME_WINGIFY = 'Wingify Logger';
    const LOGGER_NAME_VWO = 'VWO Logger';

    const BASE_URL = self::LEGACY_HOST;
    ...
    const HOST_NAME = self::LEGACY_HOST;
