...
use wingify\Enums\HttpMethodEnum;
...
class ImpressionUtil
{
    ...
    /**
     * Sends a batch of variation-shown events to the FME server.
     *
    ...
    /**
     * Sends a batch of events to the FME server.
     *
     * @param array $batchPayload The batch payload to send.
     * @return bool True if the batch of events was sent successfully, false otherwise.
     */
    ...
    /**
     * Handles the batch response from the FME server.
