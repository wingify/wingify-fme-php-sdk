...
**Existing VWO customers** can keep `composer require vwo/vwo-fme-php-sdk` and `use vwo\VWO` — see [vwo/vwo-fme-php-sdk on Packagist](https://packagist.org/packages/vwo/vwo-fme-php-sdk).
