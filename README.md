...
[![Latest Stable Version](https://img.shields.io/packagist/v/wingify/wingify-fme-php-sdk.svg?style=for-the-badge)](https://packagist.org/packages/wingify/wingify-fme-php-sdk)
[![License](https://img.shields.io/github/license/wingify/wingify-fme-node-sdk?style=for-the-badge&color=blue)](http://www.apache.org/licenses/LICENSE-2.0)

[![CI](https://img.shields.io/github/actions/workflow/status/wingify/wingify-fme-php-sdk/main.yml?style=for-the-badge&logo=github)](https://github.com/wingify/wingify-fme-php-sdk/actions?query=workflow%3ACI)
[![codecov](https://img.shields.io/codecov/c/github/wingify/wingify-fme-php-sdk?token=813UYYMWGM&style=for-the-badge&logo=codecov)](https://codecov.io/gh/wingify/wingify-fme-php-sdk)
...
| ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------- | ------------------------------- |
| `sdkKey`                     | SDK key for the environment used to initialize the Wingify SDK. You can get this key from your FME application.                              | Yes          | string    | `'32-alpha-numeric-sdk-key'`    |
| `accountId`                  | Account ID for authentication.                                                                                                                          | Yes          | string    | `'123456'`                      |                       |
| `gatewayService`             | An object representing configuration for integrating the FME Gateway Service.                                                                                   | No           | array     | see [Gateway](#gateway) section |
...
Refer to the [official FME PHP documentation](https://developers.vwo.com/v2/docs/fme-php-install) for additional parameter details.
...
The SDK by default logs all `ERROR` level messages to your server console.
To gain more control over SDK logging behaviour, you can use the `logger` parameter in the `init` configuration.
